...
/* eslint-disable func-names, prefer-arrow-callback, no-var, one-var, prefer-rest-params,
no-shadow, eqeqeq, new-cap */
...
casper.test.begin('Chugg Front-End Tests', 8, function suite(test) {
  ...
  .then(function () {
    ...
    test.assertTextExists("var closureCompiler = require('gulp-closure-compiler');",
      'Closure compiler required');
    // Tests if the gulp task has been added
    test.assertTextExists(
      "compilerPath: 'bower_components/closure-compiler/lib/vendor/compiler.jar', ",
      'Closure compiler task added');
  })
  ...
  .then(function () {
    ...
    // Tests if the closure compiler is required
    test.assertTextExists("var minifyCss = require('gulp-minify-css');",
      'Minify compiler required');
  })
